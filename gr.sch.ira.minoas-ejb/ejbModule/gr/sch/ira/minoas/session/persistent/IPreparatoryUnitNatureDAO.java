 ...
 * @version $Id$
 */
public interface IPreparatoryUnitNatureDAO extends IGenericDAO<PreparatoryUnitNature, Integer> {
	PreparatoryUnitNature findByNatureType(PreparatoryUnitNatureType natureType);
