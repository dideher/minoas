...
INSERT INTO minoas..SUITABLE_SPECIALIZATION(INSERTED_ON, VERSION, INSERTED_BY_ID, EMPLOYEE_TYPE,SPECIALIZATION_ID)
    VALUES(CURRENT_TIMESTAMP, 0, 0, 'ADMINISTRATIVE', 'ΠΕΔΙ01')
INSERT INTO minoas..SUITABLE_SPECIALIZATION(INSERTED_ON, VERSION, INSERTED_BY_ID, EMPLOYEE_TYPE,SPECIALIZATION_ID)
    VALUES(CURRENT_TIMESTAMP, 0, 0, 'ADMINISTRATIVE', 'ΠΕΔΙ02')
INSERT INTO minoas..SUITABLE_SPECIALIZATION(INSERTED_ON, VERSION, INSERTED_BY_ID, EMPLOYEE_TYPE,SPECIALIZATION_ID)
    VALUES(CURRENT_TIMESTAMP, 0, 0, 'ADMINISTRATIVE', 'ΠΕΔΙ03')
INSERT INTO minoas..SUITABLE_SPECIALIZATION(INSERTED_ON, VERSION, INSERTED_BY_ID, EMPLOYEE_TYPE,SPECIALIZATION_ID)
    VALUES(CURRENT_TIMESTAMP, 0, 0, 'ADMINISTRATIVE', 'ΠΕΔΙ04')
INSERT INTO minoas..SUITABLE_SPECIALIZATION(INSERTED_ON, VERSION, INSERTED_BY_ID, EMPLOYEE_TYPE,SPECIALIZATION_ID)
    VALUES(CURRENT_TIMESTAMP, 0, 0, 'ADMINISTRATIVE', 'ΠΕΔΙ05')
INSERT INTO minoas..SUITABLE_SPECIALIZATION(INSERTED_ON, VERSION, INSERTED_BY_ID, EMPLOYEE_TYPE,SPECIALIZATION_ID)
    VALUES(CURRENT_TIMESTAMP, 0, 0, 'ADMINISTRATIVE', 'ΠΕΔΙ06')
INSERT INTO minoas..SUITABLE_SPECIALIZATION(INSERTED_ON, VERSION, INSERTED_BY_ID, EMPLOYEE_TYPE,SPECIALIZATION_ID)
    VALUES(CURRENT_TIMESTAMP, 0, 0, 'ADMINISTRATIVE', 'ΠΕΔΙ07')
INSERT INTO minoas..SUITABLE_SPECIALIZATION(INSERTED_ON, VERSION, INSERTED_BY_ID, EMPLOYEE_TYPE,SPECIALIZATION_ID)
    VALUES(CURRENT_TIMESTAMP, 0, 0, 'ADMINISTRATIVE', 'ΠΕΔΙ08')
INSERT INTO minoas..SUITABLE_SPECIALIZATION(INSERTED_ON, VERSION, INSERTED_BY_ID, EMPLOYEE_TYPE,SPECIALIZATION_ID)
    VALUES(CURRENT_TIMESTAMP, 0, 0, 'ADMINISTRATIVE', 'ΤΕΔΙ01')
INSERT INTO minoas..SUITABLE_SPECIALIZATION(INSERTED_ON, VERSION, INSERTED_BY_ID, EMPLOYEE_TYPE,SPECIALIZATION_ID)
    VALUES(CURRENT_TIMESTAMP, 0, 0, 'ADMINISTRATIVE', 'ΤΕΔΙ02')
INSERT INTO minoas..SUITABLE_SPECIALIZATION(INSERTED_ON, VERSION, INSERTED_BY_ID, EMPLOYEE_TYPE,SPECIALIZATION_ID)
    VALUES(CURRENT_TIMESTAMP, 0, 0, 'ADMINISTRATIVE', 'ΤΕΔΙ03')
INSERT INTO minoas..SUITABLE_SPECIALIZATION(INSERTED_ON, VERSION, INSERTED_BY_ID, EMPLOYEE_TYPE,SPECIALIZATION_ID)
    VALUES(CURRENT_TIMESTAMP, 0, 0, 'ADMINISTRATIVE', 'ΤΕΔΙ04')
...
INSERT INTO EMPLOYEE_LEAVE_TYPE(VERSION, INSERTED_ON, DESCRIPTION, GENERATES_CDRS, LEGACY_CODE, EMPLOYEE_TYPE, IS_ACTIVE)
    VALUES(0,CURRENT_TIMESTAMP,'Ειδική Άδεια με Αποδοχές', 1, '61', 'ADMINISTRATIVE', 1)
INSERT INTO EMPLOYEE_LEAVE_TYPE(VERSION, INSERTED_ON, DESCRIPTION, GENERATES_CDRS, LEGACY_CODE, EMPLOYEE_TYPE, IS_ACTIVE)
    VALUES(0,CURRENT_TIMESTAMP,'Με αποδοχές', 1, '31', 'ADMINISTRATIVE', 1)
INSERT INTO EMPLOYEE_LEAVE_TYPE(VERSION, INSERTED_ON, DESCRIPTION, GENERATES_CDRS, LEGACY_CODE, EMPLOYEE_TYPE, IS_ACTIVE)
    VALUES(0,CURRENT_TIMESTAMP,'Μέχρι 1 μήνα (Απο τον Προϊστ)', 1, '50', 'ADMINISTRATIVE', 1)
INSERT INTO EMPLOYEE_LEAVE_TYPE(VERSION, INSERTED_ON, DESCRIPTION, GENERATES_CDRS, LEGACY_CODE, EMPLOYEE_TYPE, IS_ACTIVE)
    VALUES(0,CURRENT_TIMESTAMP,'Διευκόλυνση Υπαλ με ανήλικα παιδιά', 1, '57', 'ADMINISTRATIVE', 1)
INSERT INTO EMPLOYEE_LEAVE_TYPE(VERSION, INSERTED_ON, DESCRIPTION, GENERATES_CDRS, LEGACY_CODE, EMPLOYEE_TYPE, IS_ACTIVE)
    VALUES(0,CURRENT_TIMESTAMP,'1 ημέρα ανα δίμηνο', 1, '58', 'ADMINISTRATIVE', 1)
INSERT INTO EMPLOYEE_LEAVE_TYPE(VERSION, INSERTED_ON, DESCRIPTION, GENERATES_CDRS, LEGACY_CODE, EMPLOYEE_TYPE, IS_ACTIVE)
    VALUES(0,CURRENT_TIMESTAMP,'Ιδιωτ. Ιατρός', 1, '47', 'ADMINISTRATIVE', 1)
INSERT INTO EMPLOYEE_LEAVE_TYPE(VERSION, INSERTED_ON, DESCRIPTION, GENERATES_CDRS, LEGACY_CODE, EMPLOYEE_TYPE, IS_ACTIVE)
    VALUES(0,CURRENT_TIMESTAMP,'Υπεύθυνη δήλωση', 1, '42', 'ADMINISTRATIVE', 1)
INSERT INTO EMPLOYEE_LEAVE_TYPE(VERSION, INSERTED_ON, DESCRIPTION, GENERATES_CDRS, LEGACY_CODE, EMPLOYEE_TYPE, IS_ACTIVE)
    VALUES(0,CURRENT_TIMESTAMP,'Υγειον. Επιτροπή εκτός Γνωμ. ΙΔΙΩΤΗ Ιατρού', 1, '41', 'ADMINISTRATIVE', 1)


#COMMIT TRAN


#SELECT * FROM EMPLOYEE_LEAVE_TYPE WHERE LEGACY_CODE='41'
