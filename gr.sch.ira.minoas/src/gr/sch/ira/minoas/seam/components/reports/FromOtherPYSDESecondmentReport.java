...
public class FromOtherPYSDESecondmentReport extends BaseReport {
	 ...
	 * 
	 */
	public FromOtherPYSDESecondmentReport() {
	}
	...
	public void generateReport() throws Exception {
		...
		sb.append("SELECT s FROM Secondment s INNER JOIN FETCH s.employee WHERE s.active IS TRUE AND s.sourcePYSDE.localPYSDE IS FALSE ");
