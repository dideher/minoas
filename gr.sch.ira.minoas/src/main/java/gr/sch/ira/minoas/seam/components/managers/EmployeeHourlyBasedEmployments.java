...
@Name("employeeHourlyBasedEmployments")
@Scope(ScopeType.PAGE)
public class EmployeeHourlyBasedEmployments extends BaseDatabaseAwareSeamComponent {
    ...
    public void constructEmployeeEmploymentHistory() {
        this.employeeEmployments = getCoreSearching().getAllEmployeeEmploymentsOfType(employeeHome.getInstance(), EmploymentType.HOURLYBASED);
    }
