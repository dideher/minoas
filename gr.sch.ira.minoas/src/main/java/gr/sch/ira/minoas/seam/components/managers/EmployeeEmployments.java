...
public class EmployeeEmployments extends BaseDatabaseAwareSeamComponent {
    ...
    public void constructEmployeeEmploymentHistory() {
        this.employeeEmployments = getCoreSearching().getAllEmployeeEmployments(employeeHome.getInstance());
    }
