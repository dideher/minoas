 ...
 This will deploy two artifacts, target/minoas-web.war and
 default-ds.xml.
 ...
 - http://localhost:8080/minoas-web/
 ...
 Now you can either deploy the target/minoas-web.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/minoas-web.war

 To undeploy the application, run:

  ./asadmin undeploy minoas-web
